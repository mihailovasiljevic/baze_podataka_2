...
ALTER TABLE Dr?ava ADD CONSTRAINT Dr?ava_PK PRIMARY KEY ( DRZ_ID ) ;
...
ALTER TABLE Pomo?ni_objekat ADD CONSTRAINT Pomo?ni_objekat_PK PRIMARY KEY ( POM_OBJ_ID, POM_OBJ_TIP_ID ) ;


CREATE TABLE Priklju?ak
  (
    PRIK_ID  INTEGER NOT NULL ,
    PRIK_NAZ VARCHAR2 (128 CHAR) NOT NULL
  ) ;
ALTER TABLE Priklju?ak ADD CONSTRAINT Priklju?ak_PK PRIMARY KEY ( PRIK_ID ) ;


CREATE TABLE Priklju?ak_nepokretnosti
  (
    PRIK_ID    INTEGER NOT NULL ,
    NEK_ID     INTEGER NOT NULL ,
    NEK_TIP_ID CHAR (2 CHAR) NOT NULL ,
...
ALTER TABLE Priklju?ak_nepokretnosti ADD CONSTRAINT Priklju?ak_nepokretnosti_PK PRIMARY KEY ( PRIK_ID, NEK_ID, NEK_TIP_ID, PROD_ID ) ;
...
CREATE TABLE Stru?na_sprema
  (
    STRUC_SPREM_ID  CHAR (3 CHAR) NOT NULL ,
    STRUC_SPREM_NAZ VARCHAR2 (64 CHAR) NOT NULL
  ) ;
ALTER TABLE Stru?na_sprema ADD CONSTRAINT Stru?na_sprema_PK PRIMARY KEY ( STRUC_SPREM_ID ) ;


CREATE TABLE Stru?ni_ispit
  (
    STR_ISP_OZN       INTEGER NOT NULL ,
    STR_ISP_DAT_POL   DATE NOT NULL ,
    STR_ISP_DAT_PREST DATE
  ) ;
ALTER TABLE Stru?ni_ispit ADD CONSTRAINT Stru?ni_ispit_PK PRIMARY KEY ( STR_ISP_OZN ) ;
...
ALTER TABLE Agent ADD CONSTRAINT Agent_Dr?ava_FK FOREIGN KEY ( DRZ_DRZ_ID ) REFERENCES Dr?ava ( DRZ_ID ) ;

ALTER TABLE Agent ADD CONSTRAINT Agent_Stru?na_sprema_FK FOREIGN KEY ( STRUC_SPREM_ID ) REFERENCES Stru?na_sprema ( STRUC_SPREM_ID ) ;

ALTER TABLE Agent ADD CONSTRAINT Agent_Stru?ni_ispit_FK FOREIGN KEY ( STR_ISP_OZN ) REFERENCES Stru?ni_ispit ( STR_ISP_OZN ) ;

ALTER TABLE Priklju?ak_nepokretnosti ADD CONSTRAINT FK_ASS_26 FOREIGN KEY ( PRIK_ID ) REFERENCES Priklju?ak ( PRIK_ID ) ;

ALTER TABLE Priklju?ak_nepokretnosti ADD CONSTRAINT FK_ASS_27 FOREIGN KEY ( NEK_ID, NEK_TIP_ID, PROD_ID ) REFERENCES Nepokretnost ( NEK_ID, NEK_TIP_ID, PROD_ID ) ;

ALTER TABLE Grad ADD CONSTRAINT Grad_Dr?ava_FK FOREIGN KEY ( DRZ_ID ) REFERENCES Dr?ava ( DRZ_ID ) ;
...
ALTER TABLE Nepokretnost ADD CONSTRAINT Nepo_Tip_nep_FK FOREIGN KEY ( NEK_TIP_ID ) REFERENCES Tip_nepokretnosti ( NEK_TIP_ID ) ;

ALTER TABLE Pomo?ni_objekat ADD CONSTRAINT Pomo_obj_Nep_FK FOREIGN KEY ( NEK_ID, NEK_TIP_ID, PROD_ID ) REFERENCES Nepokretnost ( NEK_ID, NEK_TIP_ID, PROD_ID ) ;

ALTER TABLE Pomo?ni_objekat ADD CONSTRAINT Pom_obj_Tip_pg_obj_FK FOREIGN KEY ( POM_OBJ_TIP_ID ) REFERENCES Tip_pomocnog_objekta ( POM_OBJ_TIP_ID ) ;
...
ALTER TABLE Slika ADD CONSTRAINT Slika_Pomo?ni_objekat_FK FOREIGN KEY ( POM_OBJ_ID, POM_OBJ_TIP_ID ) REFERENCES Pomo?ni_objekat ( POM_OBJ_ID, POM_OBJ_TIP_ID ) ;

ALTER TABLE Ugovor_o_posredovanju ADD CONSTRAINT Uop_Adr_FK FOREIGN KEY ( ADRS_ID, ULICA_ID, LOK_ID, DRZ_ID ) REFERENCES Adresa ( ADRS_ID, ULICA_ID, LOK_ID, DRZ_ID ) ;
...
ALTER TABLE Ugovor_o_posredovanju ADD CONSTRAINT Uop_Nep_FK FOREIGN KEY ( NEK_ID, NEK_TIP_ID, PROD_ID ) REFERENCES Nepokretnost ( NEK_ID, NEK_TIP_ID, PROD_ID ) ;
